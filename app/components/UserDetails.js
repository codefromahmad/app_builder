...
const UserDetails = ({
  ...
  return (
    <div className="absolute w-[450px] h-[330px] z-50 bg-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 overflow-hidden">
      <div
      ...
      >
        ...
        <div className="px-8 flex flex-col justify-center bg-white scrollbar-hidden">
          ...
          <div className="flex flex-col gap-1 pt-2">
            <p className="text-black font-bold text-xs">{dictionary.email}</p>
            <input
              value={email}
          ...
          <div className="flex flex-col gap-1 pt-2">
            <p className="text-black font-bold text-xs">{dictionary.company}</p>
            <input
              value={company}
